...
MAX_BATTERY_CAPACITY = 10000  # Maximum battery capacity in µW
...
side_panel = tk.Frame(root, width=300, bg='lightgrey')
side_panel.pack(side=tk.RIGHT, fill=tk.Y)

# 23: Battery Level Bar
...
def update_battery_and_flywheel():
    global battery_level, current_energy_custom  # Ensure we use the global variable
    ...
    flywheel_canvas.create_text(50, 50, text="Flywheel", fill="white")
